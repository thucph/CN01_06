...
public class BedRoomFragment extends Fragment implements View.OnClickListener {
    ...
    public void curlRequest(String feeds) {
        String url = "https://io.adafruit.com/api/v2/thucph_bk/feeds/" + feeds + "/data/last?x-aio-key=" + MainActivity.AIO_key;
    ...
    public void sendDataMQTT(JSONObject data, String topic) {
        ...
        try {
            mqttHelper.mqttAndroidClient.publish("thucphung_bk/feeds/" + topic, message);
